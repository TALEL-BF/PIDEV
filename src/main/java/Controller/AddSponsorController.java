...
public class AddSponsorController implements Initializable {
    ...
    public void setEventHome(EventHome controller) {
        ...
        System.out.println("✅ EventHome lié au AddSponsorController");
    }
    ...
    private void goBackToSponsorTable() {
        returnToSponsorTable();  // ✅ Appelle la fonction corrigée
    }
    ...
    private void returnToSponsorTable() {
        ...
        try {
            if (eventHome != null) {
                // Si on a eventHome, on charge la table dans le contentArea
                // ✅ NOUVEAU CHEMIN: /views/SponsorTable.fxml
